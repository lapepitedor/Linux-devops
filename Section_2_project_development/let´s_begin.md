...
- A Web Server – A web server stores and delivers web pages to users over the Internet. In this project, we will use Nginx, a popular web server known for its speed and reliability.
- Linux EC2 Instance – We will use an Amazon Linux 2 EC2 instance in AWS as our virtual machine.
- Local Computer (CLI Access) – We will access the EC2 instance using Windows PowerShell or a Linux/macOS terminal.
